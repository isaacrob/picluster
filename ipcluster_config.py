...
# c.IPClusterStart.work_dir = u'/home/pi/.ipython/profile_mactopicluster/security'
...
# Set the working dir for the process.
# c.IPClusterEngines.work_dir = u'/home/pi/.ipython/profile_mactopicluster/security'
...
# c.LocalEngineLauncher.engine_cmd = ['/usr/bin/python', '-m', 'IPython.parallel.engine']
...
# command to launch the Engine.
# c.LocalEngineSetLauncher.engine_cmd = ['/usr/bin/python', '-m', 'IPython.parallel.engine']
...
# Popen command to launch ipcontroller.
# c.MPIControllerLauncher.controller_cmd = ['/usr/bin/python', '-m', 'IPython.parallel.controller']
...
# command to launch the Engine.
# c.MPIEngineSetLauncher.engine_cmd = ['/usr/bin/python', '-m', 'IPython.parallel.engine']
...
# Popen command to launch ipcontroller.
# c.SSHControllerLauncher.controller_cmd = ['/usr/bin/python', '-m', 'IPython.parallel.controller']
...
# List of (local, remote) files to send before starting
# c.SSHControllerLauncher.to_send = ['/home/pi/.ipython/profile_picluster/security/ipcontroller-engine.json']
...
# command to launch the Engine.
# c.SSHEngineLauncher.engine_cmd = ['/usr/bin/python', '-m', 'IPython.parallel.engine']
...
# command-line arguments to pass to ipengine
c.SSHEngineSetLauncher.engine_args = ['--log-to-file', '--log-level=20', '--profile=picluster']
...
# command to launch the Engine.
# c.SSHEngineSetLauncher.engine_cmd = ['/usr/bin/python', '-m', 'IPython.parallel.engine']
