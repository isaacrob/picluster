...
# c.IPControllerApp.work_dir = u'/home/pi/.ipython/profile_mactopicluster/security'
...
# c.IPControllerApp.import_statements = ['import cv2,sys,time,math,os,cPickle,signal']
